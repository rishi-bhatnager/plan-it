...
local = ".local" in HOST or "A1JHHVQ" in HOST or ".home" in HOST
# print(local)
...
ALLOWED_HOSTS = ['*'] if os.getenv('GAE_APPLICATION', None) else ['.pythonanywhere.com', '127.0.0.1', 'localhost']                                                         #not safe to use wildcard if deploying outside of GCP
